...
class MemberPromoteListViewWidget extends StatefulWidget {
  const MemberPromoteListViewWidget({super.key});

  @override
  State<MemberPromoteListViewWidget> createState() =>
      _MemberPromoteListViewWidgetState();
}

class _MemberPromoteListViewWidgetState
    extends State<MemberPromoteListViewWidget> {
  late MemberPromoteListViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MemberPromoteListViewModel());
  }
