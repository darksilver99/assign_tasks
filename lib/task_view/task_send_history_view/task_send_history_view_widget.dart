                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          if (widget!.sendDocument?.imageList != null &&
                              (widget!.sendDocument?.imageList)!.isNotEmpty)
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 8.0),
                              child: Container(
                      ...
                      if (widget!.sendDocument?.replyDate != null)
                        Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            Row(
                            ...
                            if (widget!.sendDocument?.imageReplyList != null &&
                                (widget!.sendDocument?.imageReplyList)!
                                    .isNotEmpty)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 8.0),
