...
import 'reply_detail_view_model.dart';
export 'reply_detail_view_model.dart';

class ReplyDetailViewWidget extends StatefulWidget {
  const ReplyDetailViewWidget({
    super.key,
  ...
  @override
  State<ReplyDetailViewWidget> createState() => _ReplyDetailViewWidgetState();
}

class _ReplyDetailViewWidgetState extends State<ReplyDetailViewWidget> {
  late ReplyDetailViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReplyDetailViewModel());
  }
