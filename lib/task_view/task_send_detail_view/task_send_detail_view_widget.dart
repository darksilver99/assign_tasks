...
import 'task_send_detail_view_model.dart';
export 'task_send_detail_view_model.dart';

class TaskSendDetailViewWidget extends StatefulWidget {
  const TaskSendDetailViewWidget({
    super.key,
  ...
  @override
  State<TaskSendDetailViewWidget> createState() =>
      _TaskSendDetailViewWidgetState();
}

class _TaskSendDetailViewWidgetState extends State<TaskSendDetailViewWidget> {
  late TaskSendDetailViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskSendDetailViewModel());
  }
